...
<table><center><h2>Billing Section</h2></center>
    <tr>
        <th>id</th>
        <th>Name</th>
        <th>Month</th>
...
$receive=$_GET['txt1'];
$mon=$_GET['txt2'];
$query = "SELECT * FROM history where line='$receive' && month='$mon'";
...
if ($total != 0) {
    ...
    while ($result = mysqli_fetch_assoc($data)) {
        ...
        <tr>
            ...
            <td><a href='bill.php?id=".$result['id']."' class='add-btn'>Generate</a></td>
        </tr>
        ";
        $counter++;
    }
