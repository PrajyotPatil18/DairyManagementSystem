...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_query($con, $sql)) {
        echo "<script> alert('Updated Successfully') ,window.location.href = 'showhistory.php' </script>";
        exit;
    } else {
        echo "<script> alert('Failed to Updated') ,window.location.href = 'showhistory.php' </script>";
    }
}
